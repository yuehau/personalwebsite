...
/** Floating WhatsApp button — the primary lead-gen funnel, present on every page. */
export function WhatsAppFab() {
  return (
    <a
      href={waLink(`Hi ${site.name}, I found your website and have a question.`)}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat on WhatsApp"
      className="fixed bottom-5 right-5 z-50 grid h-14 w-14 place-items-center rounded-full bg-whatsapp text-white shadow-e3 transition-transform hover:scale-110"
    >
